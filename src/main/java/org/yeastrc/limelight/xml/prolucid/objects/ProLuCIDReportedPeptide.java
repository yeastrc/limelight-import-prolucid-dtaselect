...
public class ProLuCIDReportedPeptide {

	@Override
	public String toString() {
		return "ProLuCIDReportedPeptide{" +
	...
	public boolean equals(Object o) {
		...
		ProLuCIDReportedPeptide that = (ProLuCIDReportedPeptide) o;
		return reportedPeptideString.equals(that.reportedPeptideString) &&
				nakedPeptide.equals(that.nakedPeptide) &&
				Objects.equals(mods, that.mods);
	}

	@Override
	public int hashCode() {
		return Objects.hash(reportedPeptideString, nakedPeptide, mods);
	}
